...
//echo var_dump( pathinfo($destino));
//echo var_dump( pathinfo($_POST["nombre"]));
//die();


$tipoArchivo = pathinfo($destino, PATHINFO_EXTENSION);

$destino = pathinfo($destino, PATHINFO_DIRNAME) . "/" . $_POST["sabor"] . $_POST["tipo] . date("Ymd") . "." . pathinfo($destino, PATHINFO_EXTENSION);
...
if (file_exists($destino)) {
    echo "El archivo ya existe. Se copio a backup!!!";
	$backup = "backup" . "/" . pathinfo($destino, PATHINFO_FILENAME) . "-" . date("Ymd") . "." . pathinfo($destino, PATHINFO_EXTENSION);	
	copy ( $destino , $backup);
